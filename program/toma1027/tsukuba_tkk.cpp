...
long *TOMAaddrido1,*TOMAaddrkeido1;
long *TOMAaddrido2,*TOMAaddrkeido2;
int *TOMAaddrtakasa;
...
ofstream GPSido("/media/ubuntu/TRANSCEND/1027data/latitude_goal.txt");		//outo
ofstream GPSkeido("/media/ubuntu/Transcend/1027data/scale.txt");
ofstream GPSidokeido("/media/ubuntu/Transcend/1027data/idokeido.txt");
ofstream GPSKOUHO("/media/ubuntu/Transcend/1027data/kouho.txt");
ofstream GPSkyori("/media/ubuntu/Transcend/1027data/scale.txt");
ofstream GPSaccel("/media/ubuntu/Transcend/1027data/accel.txt");

ofstream GPSmanualkyori("/media/ubuntu/Transcend/1027data/manualscale.txt");	//manual
ofstream GPSmanualidokeido("/media/ubuntu/Transcend/1027data/manualidokeido.txt");
...
int get_navi_data(int argc, char *argv[]){
...
/*		lat	= 36.532931;			//--- 変換する位置座標(B27海側)
		lon	= 136.629335; 
		hig	= 45.664;
*/
		lat_o	= 36.533275;			//--- 原点の座標(B09山側)
		lon_o	= 136.629541;
		hig_o	= 57.829900;
